# Exercícios integradores — Aula 16
...
Um `Estudante` **tem** `UsuarioBiblioteca` (composição, aula 15). Não precisa da biblioteca inteira: um campo e um getter bastam, com comentário dizendo por que não foi `extends`.
