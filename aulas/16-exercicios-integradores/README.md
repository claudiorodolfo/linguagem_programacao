# Aula 16 — Exercícios integradores
...
Não há capítulo novo. Há um mini-sistema (`src/`) e uma lista longa para a semana da aula 15. Escolha: **trilha A** (obrigatória) e **trilha B** (desafio).
...
3. Mapa da prova 3: o que cobra (ver `aulas/17-prova-unidade-3/README.md`).

## Compilar

```bash
javac aulas/16-exercicios-integradores/src/*.java
java -cp aulas/16-exercicios-integradores/src DemoBoletim
```
