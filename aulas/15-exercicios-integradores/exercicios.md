# Exercícios integradores — Aula 15
...
Um `Estudante` **tem** `UsuarioBiblioteca` (composição, aula 13). Não precisa da biblioteca inteira: um campo e um getter bastam, com comentário dizendo por que não foi `extends`.
