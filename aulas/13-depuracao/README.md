# Aula 13 — Depuração de programas
...
A pilha de chamadas do depurador é a **mesma** da recursão (aula 07): cada chamada empilha um quadro. Na próxima aula o perigo muda de forma: `Integer` `null` vira `int` e a JVM lança NPE no unboxing — pause no depurador e veja.
