# Aula 15 — Boas práticas de programação

**Data:** 07/12  
**Unidade:** 3  
**Pré-requisito:** Unidade 2 e aulas 13–14 (já há código “grande” o bastante para ficar ruim)
...
```bash
javac aulas/15-boas-praticas/src/*.java
java -cp aulas/15-boas-praticas/src AntiPadrao

javac aulas/15-boas-praticas/versao-limpa/*.java
java -cp aulas/15-boas-praticas/versao-limpa DemoLimpo
```
