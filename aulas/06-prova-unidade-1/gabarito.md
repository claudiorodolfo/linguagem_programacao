...
c) Classe associativa concentra a nota e o vínculo. Duas listas cruzadas duplicam a relação e ficam fáceis de dessincronizar. É o padrão N–N da aula 05 (`Emprestimo`, `Matricula`).
