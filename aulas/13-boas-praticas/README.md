# Aula 13 — Boas práticas de programação

**Data:** 23/11  
**Unidade:** 3  
**Pré-requisito:** Unidade 2 (já há código “grande” o bastante para ficar ruim)
...
`protected double saldo` da aula 08: honesto para ensinar herança; em código “limpo”, `private` + `protected void debitar`.
...
```bash
javac aulas/13-boas-praticas/src/*.java
java -cp aulas/13-boas-praticas/src AntiPadrao

javac aulas/13-boas-praticas/versao-limpa/*.java
java -cp aulas/13-boas-praticas/versao-limpa DemoLimpo
```

## Ponte para a aula 14

Mesmo com nomes bonitos, `ArrayList` não guarda `int` — guarda `Integer`. Boxing mal entendido produz NPE “do nada”. É o último tópico novo da ementa.
