...
Todos com `toString` incluindo o tipo. Array `Midia[]` no `main` (mesmo sem polimorfismo de método ainda: você vai chamar `toString`, que já é polimórfico — spoiler controlado da aula 09).
